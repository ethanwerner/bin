...
int32_t bin_file_read( char const *, int64_t, void *, uint64_t );
int32_t bin_file_write( char const *, int64_t, void *, uint64_t );
int32_t bin_file_insert( char const *, int64_t, void *, uint64_t );
int32_t bin_file_append( char const *, void *, uint64_t );
uint64_t bin_file_length( char const * );
...
int32_t bin_file_read( char const *path, int64_t i, void *data, uint64_t n )
{
	FILE *bin = bin_open( path );
...
int32_t bin_file_write( char const *path, int64_t i, void *data, uint64_t n )
{
	FILE *bin = bin_open( path );
...
int32_t bin_file_insert( char const *path, int64_t i, void *data, uint64_t n )
{
	FILE *bin = bin_open( path );
...
int32_t bin_file_append( char const *path, void *data, uint64_t n )
{
	FILE *bin = bin_open( path );
...
uint64_t bin_file_length( char const *path )
{
	FILE *bin = bin_open( path );
